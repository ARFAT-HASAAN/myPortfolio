...
const Skills = () => {
    return (
        <div    name="skills" className='bg-gray-900 text-gray-300 w-full md:h-screen py-5 md:py-0 '>
            <div
                data-aos="flip-left"
               ...
               <div className=''>
                    <h1 className='border-b-2 inline border-[#FF1600] text-3xl font-bold' >Skills</h1>
                     <p className='py-3 text-2xl'>// These are the technologies I've worked with.</p>
                 </div>
                ...
                <div className='w-full grid grid-cols-2 md:grid-cols-4 gap-8 text-center '>
                    ...
                    <div className='cursor-pointer shadow-md shadow-gray-600 hover:scale-110 duration-500 p-4'>
                        <img src={Tawilwind} className="w-20 mx-auto" alt="tawilwind images" />
                    ...
                    <div className='cursor-pointer shadow-md shadow-gray-600 hover:scale-110 duration-500 p-4'>
                        <img src={Bootstrap} className="w-20 mx-auto" alt="bootstrap images" />
